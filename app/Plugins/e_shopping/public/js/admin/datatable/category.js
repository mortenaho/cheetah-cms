...
// set data to table
    var table = $("#category-table").DataTable({
        ...
        'ajax': "/admin/ec/dtAjaxData/category",
            ...
            },
            {
                "mRender": function (data, type, row) {
                    return '<ul class="icons-list">' +
                        '<li class="btn btn-primary btn-icon btn-rounded legitRipple"><a href="/admin/ec/category/' + row.id + '/edit"><i class="icon-pencil7"></i></a></li>' +
...
function changeStatus(id) {
    var request = $.ajax({
        url: "/admin/ec/category/status/" + id,
        type: "POST",
        data: {id: id},
        dataType: "json"
    });
