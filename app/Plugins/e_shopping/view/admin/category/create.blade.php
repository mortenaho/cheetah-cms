...
@section("body")
    <form id="frmCategory" method="post" class="validate" action="/admin/ec/category">
        <div class="row">
            <div class="col-lg-8">
                {{csrf_field()}}
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div id="category_select">
                                @include('e_shopping::admin.category._category')
                            </div>
...
@endsection
@push("script")
    <script src="{{plugin_assets('e_shopping/public/js/admin/category.js')}}"></script>
