...
namespace App\Themes\finarc\Controllers;
...
class Controller extends BaseController
{
    ...
    public function __construct()
    {
        ...
        $footerGallery = DB::table("post")->where("post_type", "=", "gallery")->where("parent", " = ", null)->where("language", "=", "$this->lang")->where("status", "=", "1")->orderBy("created_at", "desc")->limit(6)->get();
        if (!cache()->has("all")) {
        ...
        view()->share(compact('menu', 'site', 'contact_info', 'plugin','locale','footerGallery'));
    }
