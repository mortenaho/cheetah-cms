            ...
            <div class="container">
                <div class="text-center">
                    <div class="footer-link">
                        <ul>
                            <li><a href="/{{$locale}}/about_us" data-hover="About">درباره ما</a></li>
                            <li>
                                <a href="/{{$locale}}/services" data-hover="Gallery">خدمات</a>
                            </li>
                            <li><a href="/{{$locale}}/blog" data-hover="Blog">وبلاگ</a></li>
                            <li>
                                <a href="/{{$locale}}/portfolio" data-hover="Portfolio"
                                >نمونه کارها</a
                                >
                            </li>
                            <li>
                                <a href="/{{$locale}}/contact_us" data-hover="Contact Us"
                                >تماس با ما</a
                                >
                            </li>
                        </ul>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="widget text-center">
                            ...
                            <div class="widget-section">
                                ...
                                <img src="{{$site->footer_logo}}" alt="{{$site->site_name}}"  width="200"/>
                            </div>
                        </div>
                    </div>
                    <!-- TAGS -->
