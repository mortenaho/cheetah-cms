@extends("admin.shared._AdminLayout",["title"=>"افزودن محصول جدید"])
...
@section("pageHeader")
    ...
    "pageHeaderLinks"=>[
     ...
     "pageHeaderActive"=>"افزودن  محصول"
    ])
@endsection

@section("body")
    <form id="frmProduct" method="post" class="validate" action="/admin/product">
        <div class="row">
            <div class="col-lg-8">
                {{csrf_field()}}
                <div class="card">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input id="discount" name="discount" type="text" class="form-control"
                                       placeholder=" تخفیف " value="{{old("discount")}}">
                            </div>
                        </div>
                    </div>
