@extends("admin.shared._AdminLayout",["title"=>"افزودن دانلود جدید"])

@section("pageHeader")
    @include("admin.shared._PageHeader",
    ["pageTitle"=>"افزودن دانلود جدید",
    "pageHeaderLinks"=>[
         ["title"=>"  دانلود ها","link"=>"/admin/download"]
    ],
     "pageHeaderActive"=>"افزودن  دانلود"
    ])
@endsection

@section("body")
    <form id="frmDownload" method="post" class="validate" action="/admin/download">
        {{csrf_field()}}
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h5 class="card-title"> افزودن دانلود </h5>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input id="project" name="project" type="text" class="form-control"
                                           placeholder=" پروژه " value="{{old("project")}}">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input id="customer" name="customer" type="text" class="form-control"
                                           placeholder=" مشتری " value="{{old("customer")}}">
