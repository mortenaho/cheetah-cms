@extends("admin.shared._AdminLayout",["title"=>"افزودن آموزش جدید"])

@section("pageHeader")
    @include("admin.shared._PageHeader",
    ["pageTitle"=>"افزودن آموزش جدید",
    "pageHeaderLinks"=>[
         ["title"=>"  آموزش","link"=>"/admin/training"]
    ],
     "pageHeaderActive"=>"افزودن  آموزش"
    ])
@endsection

@section("body")
    <form id="frmService" method="post" class="validate" action="/admin/training">
        ...
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h5 class="card-title"> افزودن آموزش</h5>
            ...
            <div class="col-lg-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label class="display-block">تصویر شاخص آموزش:</label>
                            <div class="thumb">
                                <img id="img_thumb"
...
@endsection
@push("script")
    <script src="/admin_assets/custom/forms/training.js"></script>
