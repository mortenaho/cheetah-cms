@extends("admin.shared._AdminLayout",["title"=>"ویرایش آموزش "])

@section("pageHeader")
    @include("admin.shared._PageHeader",
    ["pageTitle"=>"ویرایش آموزش ",
    "pageHeaderLinks"=>[
         ["title"=>"  آموزش","link"=>"/admin/training"]
    ],
     "pageHeaderActive"=>"ویرایش  آموزش"
    ])
@endsection

@section("body")
    <form id="frmTraining" method="post" class="validate" action="/admin/training/{{$training->id}}">
        <input type="hidden" name="_method" value="PUT">
        <input type="hidden" name="id" value="{{$training->id}}">
        <input type="hidden" name="ordering" value="{{$training->ordering}}">
        <div class="row">
            <div class="col-lg-8">
                {{csrf_field()}}
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h5 class="card-title"> ویرایش آموزش</h5>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="title" name="title" type="text" class="form-control"
                                   placeholder=" عنوان " required="required" value="{{$training->title}}">
                        ...
                        <textarea id="content" name="content" class="form-control" rows="18"
                                  placeholder="">{{$training->content}}</textarea>
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea name="excerpt" maxlength="255" class="form-control maxlength"
                                      placeholder=" توضیحات مختصر ">{{$training->excerpt}}</textarea>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            @include("admin.service._category",["categories"=>$categories,"category_id"=>$training->category_id])
                            ...
                            <div class="form-group">
                                ...
                                <select name="language" id="language" class="form-control select" required="required">
                                    ...
                                    @foreach(language as $lang)
                                        <option
                                            @if($training->language===$lang["name"]) selected="selected"
                        ...
                        <div class="form-group">
                            ...
                            <label>فعال :
                                <input @if($training->status===1)  checked="checked" @endif type="radio" name="status"
                                       class="styled" value="1">
                            </label>
                            <label>غیر فعال :
                                <input @if($training->status===0)  checked="checked" @endif type="radio" name="status"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="thumb">
                                <img id="img_thumb"
                                     src="@if($training->thumb!=null) {{$training->thumb}} @else/admin_assets/assets/images/placeholder.jpg @endif"
                                     alt="">
                            ...
                            <input value="{{$training->thumb}}" id="thumb"
