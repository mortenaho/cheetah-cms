...
@section("body")
    <form id="frmCustomer" method="post" class="validate" action="/admin/client/{{$client->id}}">
        <input type="hidden" name="_method" value="PUT">
        <input type="hidden" name="id" value="{{$client->id}}">
        <input type="hidden" name="ordering" value="{{$client->ordering}}">
        <div class="row">
            <div class="col-lg-8">
                {{csrf_field()}}
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="title" name="title" type="text" class="form-control"
                                   placeholder=" عنوان " required="required" value="{{$client->title}}">
                        ...
                        <div class="form-group">
                            ...
                            <input id="link_address" name="link_address" type="text" class="form-control"
                                   placeholder=" http://www.naw3.com " value="{{$client->link_address}}">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="language" id="language" class="form-control select" required="required">
                                    ...
                                    @foreach(language as $lang)
                                        <option
                                            @if($client->language===$lang["name"]) selected="selected"
                        ...
                        <div class="form-group">
                            ...
                            <label>فعال :
                                <input @if($client->status===1)  checked="checked" @endif type="radio" name="status"
                                       class="styled" value="1">
                            </label>
                            <label>غیر فعال :
                                <input @if($client->status===0)  checked="checked" @endif type="radio" name="status"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="thumb">
                                <img id="img_thumb"
                                     src="@if($client->thumb!=null) {{$client->thumb}} @else/admin_assets/assets/images/placeholder.jpg @endif"
                                     alt="">
                            ...
                            <input value="{{$client->thumb}}" id="thumb"
