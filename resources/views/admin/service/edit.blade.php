@extends("admin.shared._AdminLayout",["title"=>"ویرایش خدمات "])

@section("pageHeader")
    @include("admin.shared._PageHeader",
    ["pageTitle"=>"ویرایش خدمات ",
    "pageHeaderLinks"=>[
         ["title"=>"  خدمات","link"=>"/admin/service"]
    ],
     "pageHeaderActive"=>"ویرایش  خدمات"
    ])
@endsection

@section("body")
    <form id="frmService" method="post" class="validate" action="/admin/service/{{$service->id}}">
        <input type="hidden" name="_method" value="PUT">
        <input type="hidden" name="id" value="{{$service->id}}">
        <input type="hidden" name="ordering" value="{{$service->ordering}}">
        <div class="row">
            <div class="col-lg-8">
                {{csrf_field()}}
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h5 class="card-title"> ویرایش خدمات</h5>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="title" name="title" type="text" class="form-control"
                                   placeholder=" عنوان " required="required" value="{{$service->title}}">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <textarea name="excerpt" maxlength="255" class="form-control maxlength"
                                      placeholder=" توضیحات مختصر ">{{$service->excerpt}}</textarea>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            @include("admin.service._category",["categories"=>$categories,"category_id"=>$service->category_id])
                            ...
                            <div class="form-group">
                                ...
                                <select name="language" id="language" class="form-control select" required="required">
                                    ...
                                    @foreach(language as $lang)
                                        <option
                                            @if($service->language===$lang["name"]) selected="selected"
                        ...
                        <div class="form-group">
                            ...
                            <label>فعال :
                                <input @if($service->status===1)  checked="checked" @endif type="radio" name="status"
                                       class="styled" value="1">
                            </label>
                            <label>غیر فعال :
                                <input @if($service->status===0)  checked="checked" @endif type="radio" name="status"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="thumb">
                                <img id="img_thumb"
                                     src="@if($service->thumb!=null) {{$service->thumb}} @else/admin_assets/assets/images/placeholder.jpg @endif"
                                     alt="">
                            ...
                            <input value="{{$service->thumb}}" id="thumb"
