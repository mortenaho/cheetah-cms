@extends("admin.shared._AdminLayout",["title"=>"افزودن گواهینامه ها جدید"])

@section("pageHeader")
    @include("admin.shared._PageHeader",
    ["pageTitle"=>"افزودن گواهینامه ها جدید",
    "pageHeaderLinks"=>[
         ["title"=>"  گواهینامه ها","link"=>"/admin/certificate"]
    ],
     "pageHeaderActive"=>"افزودن  گواهینامه ها"
    ])
@endsection
...
@section("body")
    ...
    <form id="frmCertificate" method="post" class="validate form-horizontal" action="/admin/certificate">
        <div class="row">
            <div class="col-md-8">
                {{csrf_field()}}
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h5 class="card-title"> افزودن گواهینامه ها</h5>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <div class="thumb">
                                <img id="img_thumb"
                                     src="/admin_assets/global_assets/images/placeholder.jpg"
                                     alt="">
