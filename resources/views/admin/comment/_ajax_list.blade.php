            ...
            <div class="panel panel-white">
                <div class="panel-heading">
                    ...
                    <div class="heading-elements not-collapsible">
                        <span class="label bg-blue heading-text">{{$comment->count()}} پیام جدید</span>
                    </div>
                </div>
                        ...
                        <div class="navbar-collapse collapse" id="inbox-toolbar-toggle-single">
                            ...
                            <div class="navbar-right">
                                <p class="navbar-text"><span class="text-semibold">۱-۲۰</span> از <span
                                        class="text-semibold">{{$comment->total()}}</span></p>

                                <div class="btn-group navbar-left navbar-btn">
                                    <a href="{{$comment->previousPageUrl()}}"  class="btn btn-default btn-icon @if($comment->currentPage()===1) disabled @endif"><i
                                            class="icon-arrow-right13"></i></a>
                                    <a href="{{$comment->nextPageUrl()}}"  class="btn btn-default btn-icon @if($comment->currentPage()===$comment->lastPage()) disabled @endif"><i
