@extends("admin.shared._AdminLayout",["title"=>"افزودن نمونه کار جدید"])

@section("pageHeader")
    @include("admin.shared._PageHeader",
    ["pageTitle"=>"افزودن نمونه کار جدید",
    "pageHeaderLinks"=>[
         ["title"=>"  نمونه کار","link"=>"/admin/portfolio"]
    ],
     "pageHeaderActive"=>"افزودن  نمونه کار"
    ])
@endsection

@section("body")
    <form id="frmPortfolio" method="post" class="validate" action="/admin/portfolio">
        {{csrf_field()}}
        <div class="row">
            <div class="col-lg-8">
