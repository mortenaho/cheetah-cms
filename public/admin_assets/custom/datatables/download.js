...
// set data to table
    var table = $("#download-table").DataTable({
        ...
        "preDrawCallback": function( settings ) {
            loadingElement('#download-table_wrapper',true);
        },
        'ajax': "/admin/dtAjaxData/download",
            ...
            },
            {
                "mRender": function (data, type, row) {
                    return '<ul class="icons-list">' +
                        ...
                        '<li class="btn btn-primary btn-icon btn-rounded legitRipple"><a href="/admin/download/' + row.id + '/edit"><i class="icon-pencil7"></i></a></li>' +
        ...
        "drawCallback": function( settings ) {
            ...
            loadingElement('#download-table_wrapper',false);
        }
    });
    ...
    function changeFeatured(id) {
        var request = $.ajax({
            url: "/admin/download/featured/" + id,
            type: "POST",
            data: {id: id},
            dataType: "json"
        });
...
function changeStatusSwitch(id) {
    console.log(id);
    var loadElement =  $('#download-table_wrapper');
