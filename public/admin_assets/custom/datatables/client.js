...
// set data to table
    var table = $("#client-table").DataTable({
        ...
        "preDrawCallback": function( settings ) {
            loadingElement('#client-table_wrapper',true);
        },
        'ajax': "/admin/dtAjaxData/client",
            ...
            },
            {
                "mRender": function (data, type, row) {
                    return '<ul class="icons-list">' +
                        '<li class="btn btn-primary btn-icon btn-rounded legitRipple"><a href="/admin/client/' + row.id + '/edit"><i class="icon-pencil7"></i></a></li>' +
        ...
        "drawCallback": function( settings ) {
            ...
            loadingElement('#client-table_wrapper',false);
        }
    });
...
function changeStatusSwitch(id) {
    console.log(id);
    var loadElement =  $('#client-table_wrapper');
