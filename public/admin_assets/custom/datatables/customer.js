...
// set data to table
    var table = $("#customer-table").DataTable({
        ...
        "preDrawCallback": function( settings ) {
            loadingElement('#customer-table_wrapper',true);
        },
        'ajax': "/admin/dtAjaxData/customer",
            ...
            },
            {
                "mRender": function (data, type, row) {
                    return '<ul class="icons-list">' +
                        '<li class="btn btn-primary btn-icon btn-rounded legitRipple"><a href="/admin/customer/' + row.id + '/edit"><i class="icon-pencil7"></i></a></li>' +
        ...
        "drawCallback": function( settings ) {
            ...
            loadingElement('#customer-table_wrapper',false);
        }
    });
    ...
    function changeFeatured(id) {
        var request = $.ajax({
            url: "/admin/customer/featured/" + id,
            type: "POST",
            data: {id: id},
            dataType: "json"
        });
