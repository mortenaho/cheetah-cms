...
// set data to table
    var table = $("#social-table").DataTable({
        'processing': true,
        'serverSide': true,
        'oLanguage': dataTable_lang,
        "preDrawCallback": function( settings ) {
            loadingElement('#social-table_wrapper',true);
        },
        'ajax': "/admin/dtAjaxData/social",
            ...
            },
            {
                "mRender": function (data, type, row) {
                    return '<ul class="icons-list">' +
                        '<li class="btn btn-primary btn-icon btn-rounded legitRipple"><a href="/admin/Social/' + row.id + '/edit"><i class="icon-pencil7"></i></a></li>' +
        ...
        "drawCallback": function( settings ) {
            ...
            loadingElement('#social-table_wrapper',false);
        }
    });
...
function changeStatusSwitch(id) {
    console.log(id);
    var loadElement =  $('#social-table_wrapper');
