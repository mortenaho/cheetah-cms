...
// set data to table
    var table = $("#portfolio-table").DataTable({
        ...
        "preDrawCallback": function( settings ) {
            loadingElement('#portfolio-table_wrapper',true);
        },
        'ajax': "/admin/dtAjaxData/portfolio",
            ...
            },
            {
                "mRender": function (data, type, row) {
                    return '<ul class="icons-list">' +
                        ...
                        '<li class="btn btn-primary btn-icon btn-rounded legitRipple"><a href="/admin/portfolio/' + row.id + '/edit"><i class="icon-pencil7"></i></a></li>' +
        ...
        "drawCallback": function( settings ) {
            ...
            loadingElement('#portfolio-table_wrapper',false);
        }
    });
    ...
    function changeFeatured(id) {
        var request = $.ajax({
            url: "/admin/portfolio/featured/" + id,
            type: "POST",
            data: {id: id},
            dataType: "json"
        });
...
function changeStatusSwitch(id) {
    console.log(id);
    var loadElement =  $('#portfolio-table_wrapper');
