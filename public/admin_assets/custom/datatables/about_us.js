...
// set data to table
    var table = $("#about_us-table").DataTable({
        'processing': true,
        'serverSide': true,
        'oLanguage': dataTable_lang,
        "preDrawCallback": function( settings ) {
            loadingElement('#about_us-table_wrapper',true);
        },
        'ajax': "/admin/dtAjaxData/about_us",
            ...
            },
            {
                "mRender": function (data, type, row) {
                    return '<ul class="icons-list">' +
                        '<li class="btn btn-primary btn-icon btn-rounded legitRipple"><a href="/admin/about_us/' + row.id + '/edit"><i class="icon-pencil7"></i></a></li>' +
        ...
        "drawCallback": function( settings ) {
            ...
            loadingElement('#about_us-table_wrapper',false);
        }
    });
...
function changeStatusSwitch(id) {
    console.log(id);
    var loadElement =  $('#about_us-table_wrapper');
