$(document).ready(function () {
    // set data to table
    var table = $("#contact_info-table").DataTable({
        'processing': true,
        'serverSide': true,
        'oLanguage': dataTable_lang,
        "preDrawCallback": function( settings ) {
            loadingElement('#contact_info-table_wrapper',true);
        },
        'ajax': "/admin/dtAjaxData/contact_info",
            ...
            },
            {
                "mRender": function (data, type, row) {
                    return '<ul class="icons-list">' +
                        '<li class="btn btn-primary btn-icon btn-rounded legitRipple"><a href="/admin/contact_info/' + row.id + '/edit"><i class="icon-pencil7"></i></a></li>' +
        ...
        "drawCallback": function( settings ) {
            ...
            loadingElement('#contact_info-table_wrapper',false);
        }
    });
    ...
    function changeStatus(id) {
        var request = $.ajax({
            url: "/admin/contact_info/status/" + id,
            type: "POST",
            data: {id: id},
            dataType: "json"
        });
...
function changeStatusSwitch(id) {
    console.log(id);
    var loadElement =  $('#contact_info-table_wrapper');
