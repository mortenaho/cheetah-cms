...
// set data to table
    var table = $("#menu-table").DataTable({
        ...
        "preDrawCallback": function( settings ) {
            loadingElement('#menu-table_wrapper',true);
        },
        'ajax': "/admin/dtAjaxData/menu",
            ...
            },
            {
                "mRender": function (data, type, row) {
                    return '<ul class="icons-list">' +
                        '<li class="btn btn-primary btn-icon btn-rounded legitRipple"><a href="/admin/menu/' + row.id + '/edit"><i class="icon-pencil7"></i></a></li>' +
        ...
        "drawCallback": function( settings ) {
            ...
            loadingElement('#menu-table_wrapper',false);
        }
    });
...
function changeStatusSwitch(id) {
    console.log(id);
    var loadElement =  $('#menu-table_wrapper');
