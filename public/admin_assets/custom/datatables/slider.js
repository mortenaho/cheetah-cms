...
// set data to table
    var table = $("#slider-table").DataTable({
        ...
        "preDrawCallback": function( settings ) {
            loadingElement('#slider-table_wrapper',true);
        },
        'ajax': "/admin/dtAjaxData/slider",
        ...
        "columns": [
            ...
            {"data": "created_at"},
            {
                "mRender": function (data, type, row) {
                    return '  <a href="' + row.photo + '" data-popup="lightbox">' +
                        '<img src="' + row.photo + '" alt="" class="img-rounded img-preview">' +
                        '</a>';
            ...
            },
            {
                "mRender": function (data, type, row) {
                    return '<ul class="icons-list">' +
                        '<li class="btn btn-primary btn-icon btn-rounded legitRipple"><a href="/admin/Slider/' + row.id + '/edit"><i class="icon-pencil7"></i></a></li>' +
        ...
        "drawCallback": function( settings ) {
            ...
            loadingElement('#slider-table_wrapper',false);
        }
    });
...
function changeStatusSwitch(id) {
    console.log(id);
    var loadElement =  $('#slider-table_wrapper');
