$(document).ready(function () {
    ...
    var table = $("#certificate-table").DataTable({
        ...
        "preDrawCallback": function (settings) {
            loadingElement('#certificate-table_wrapper', true);
        },
        'ajax': "/admin/dtAjaxData/certificate",
            ...
            },
            {
                "mRender": function (data, type, row) {
                    return '<ul class="icons-list">' +
                        '<li class="btn btn-primary btn-icon btn-rounded  legitRipple"><a href="/admin/certificate/' + row.id + '/edit" class="text-white"><i class="icon-pencil7"></i></a></li>' +
        ...
        "drawCallback": function (settings) {
            ...
            loadingElement('#certificate-table_wrapper', false);
        }
    });
    ...
    function changeStatus(id) {
        var request = $.ajax({
            url: "/admin/certificate/status/" + id,
            type: "POST",
            data: {id: id},
            dataType: "json"
        });
    ...
    function changeFeatured(id) {
        var request = $.ajax({
            url: "/admin/certificate/featured/" + id,
            type: "POST",
            data: {id: id},
            dataType: "json"
        });
...
function changeStatusSwitch(id) {
    console.log(id);
    var loadElement = $('#certificate-table_wrapper');
