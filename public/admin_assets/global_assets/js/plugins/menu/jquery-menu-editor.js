...
function MenuEditor(idSelector, options) {
    var $main = $("#" + idSelector);
    var settings = {
        labelEdit: '<i class="icon-pencil7 clickable"></i>',
        labelRemove: '<i class="icon-trash clickable"></i>',
        ...
        listOptions: {
            ...
            opener: {
                as: 'html',
                close: '<i class="icon-minus3"></i>',
                open: '<i class="icon-plus3"></i>',
    ...
    function TButtonGroup() {
        ...
        var $btnUp = TButton({classCss: 'btn btn-secondary btn-sm btnUp btnMove', text: '<i class="icon-arrow-up12 clickable"></i>'});
        var $btnDown = TButton({classCss: 'btn btn-secondary btn-sm btnDown btnMove', text: '<i class="icon-arrow-down12 clickable"></i>'});
        var $btnOut = TButton({classCss: 'btn btn-secondary btn-sm btnOut btnMove', text: '<i class="icon-move-down clickable"></i>'});
        var $btnIn = TButton({classCss: 'btn btn-secondary btn-sm btnIn btnMove', text: '<i class="icon-move-up clickable"></i>'});
